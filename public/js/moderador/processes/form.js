//Slug automático
document.getElementById("code").addEventListener('keyup', slugChange);
...
function slug(str) {
    ...
    .create(document.querySelector('#description_en'), {
        toolbar: ['heading', '|', 'bold', 'italic', 'link', 'bulletedList', 'numberedList', 'blockQuote','alignment', '|', 'alignment:left', 'alignment:right', 'alignment:center', 'alignment:justify'],
            heading: {
            options: [{
                    model: 'paragraph',
                    title: 'Paragraph',
