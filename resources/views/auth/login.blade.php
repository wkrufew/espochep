<x-app-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center mt-4 flex-col md:flex-row md:justify-between">
                
                <a href="{{ route('register') }}" class="underline text-sm text-gray-600 hover:text-gray-900">¿No tiene cuenta?</a>
                @if (Route::has('password.request'))
                    <a class="underline mt-2 md:mt-0 text-sm text-gray-600 hover:text-gray-900" href="{{ route('password.request') }}">
                        {{ __('Forgot your password?') }}
                    </a>
                @endif

                <x-jet-button class="ml-1 mt-4 md:mt-0">
                    {{ __('Log in') }}
                </x-jet-button>
            </div>
        </form>
...
{{-- <x-guest-layout>
    ...
    <div class="lg:flex">
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-6 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    <div>
                        <img class="w-16 md:w-20 hidden md:block" src="{{ asset('fotos/logo_fundation.png') }}" alt="logo">
                    </div>
                    
                    <a class="text-3xl text-red-700 font-display text-center xl:text-5xl tracking-wide font-semibold" href="{{route('home')}}">ESPOCH EP</a>
                </div>
            </div>
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <h2 class="text-center text-3xl text-neutral-900 font-display font-semibold lg:text-left xl:text-4xl
                ...
                <div class="mt-12">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            ...
                            <div class="text-sm font-bold text-neutral-900 tracking-wide ml-4">Correo</div>
                        ...
                        <div class="mt-8">
                            <div class="flex justify-between items-center">
                                <div class="text-sm font-bold text-neutral-900 tracking-wide ml-4">
                                    Contraseña
                                </div>
                        ...
                        <div class="mt-10">
                            <button class="bg-neutral-900 text-gray-50 p-4 w-full rounded-full tracking-wide
                            font-semibold font-display focus:outline-none text-md focus:shadow-outline hover:bg-neutral-700
                            shadow-xl">
                                Iniciar
                            </button>
                        </div>
        ...
        <div class="hidden lg:flex items-center justify-center bg-neutral-300 flex-1 h-screen">
            ...
            <div class="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
                <svg class="w-5/6 mx-auto" xmlns="http://www.w3.org/2000/svg" id="f080dbb7-9b2b-439b-a118-60b91c514f72" data-name="Layer 1" viewBox="0 0 528.71721 699.76785">
                    <title>Login</title>
                    <rect y="17.06342" width="444" height="657" fill="#a51515"/>
                    <polygon points="323 691.063 0 674.063 0 17.063 323 0.063 323 691.063" fill="#a51515"/>
                    <circle cx="296" cy="377.06342" r="4" fill="#a51515"/>
                    <polygon points="296 377.66 298.773 382.463 301.545 387.265 296 387.265 290.455 387.265 293.227 382.463 296 377.66" fill="#a51515"/>
                    <polygon points="337 691.063 317.217 691 318 0.063 337 0.063 337 691.063" fill="#a51515"/>
                    <g opacity="0.1">
                    ...
                    <circle cx="296" cy="346.06342" r="13" fill="#a2020"/>
                    ...
                    <ellipse cx="463.21721" cy="95.32341" rx="39.5" ry="37" fill="#a51515"/>
