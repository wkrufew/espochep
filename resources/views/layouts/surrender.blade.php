    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <!-- CONTENIDO PRINCIPAL DEL A PLANTILLA DE MODERADORES -->
            <div class="max-w-7xl mx-auto rounded-lg px-6 py-4 grid grid-cols-1 lg:grid-cols-5 lg:gap-4">
                <aside class="mb-4">
                    <h1 class="font-bold mx-2 py-2 rounded-lg text-sm mt-2  mb-4 text-center bg-neutral-900 text-white">RENDICIÓN DE CUENTAS</h1>
                    <ul class="overflow-hidden bg-white text-sm p-3 rounded-lg shadow-lg text-neutral-900 mb-10 ml-2 mr-2">
                        <li class="my-1 leading-7 rounded-lg pl-2 @routeIs('moderador.surrenders.edit', $surrender) bg-neutral-900 text-white @else  @endif hover:bg-red-700 hover:text-neutral-50">
                            <a href="{{ route('moderador.surrenders.edit', $surrender) }}">Información de Rendicion</a>
                        </li>
                        <hr>
                        <li class="my-1 leading-7 rounded-lg pl-2 @routeIs('moderador.surrenders.stages', $surrender) bg-neutral-900 text-white @else @endif hover:bg-red-700 hover:text-neutral-50">
                            <a href="{{ route('moderador.surrenders.stages', $surrender) }}">Fases de la Rendición</a>
                        </li>
                        <hr>
                        <li class="my-1 leading-7 rounded-lg pl-2 hover:bg-red-700 hover:text-neutral-50 ">
                            <a href="{{ route('moderador.surrenders.index') }}">Volver al Listado</a>
                        </li>
                    </ul>
                        ...
                        @case(1)
                            <div class="text-center bg-white p-4 rounded-lg">
                                <div class="bg-red-500 text-gray-50 rounded-lg">
                                    <p class="text-sm text-center px-3 py-1">Fase en Borrador</p>
                                </div>
                            </div>
                            @break
                        @case(2)
                            <div class="text-center bg-white p-4 rounded-lg">
                                <div class="bg-green-600 text-gray-50 rounded-lg">
                                    <p class="text-sm text-center px-3 py-1">Fase Publicada</p>
                                </div>
                            </div>
                            @break     
                        @default
