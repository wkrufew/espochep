<x-app-layout>
    @section('meta_tag')
        <title>ESPOCHEP|PROCESS</title>
        {{-- SEO --}}
        <meta name="robots" content="index, follow">
        <meta name="title" content="ESPOCH EP|PROCESS">
        <meta name="description" content="ESPOCHEP, es una empresa dedicada a las compras publicas" >
        <!-- Open Graph data -->
        <meta property="og:title" content="ESPOCH EP|PROCESS">
    ...
    <div class="max-w-6xl mx-auto">
        <div class="fondo m-6 py-4 md:py-6 px-6 rounded-lg text-center text-white font-semibold text-md">
            {{ __('LISTADO DE PROCESOS') }}
        </div>
    </div>
    
    <div class="w-full md:max-w-3xl mx-auto px-1 mb-5">
        <div class="bg-white py-2 px-1 md:px-6 rounded-lg shadow-lg">
            @livewire('search')
        </div>
    </div>
    <div class="py-2 mb-4 mx-2">
