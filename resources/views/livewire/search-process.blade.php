<div>
    <div class="flex justify-center items-center">
        <div class="flex">
                <!-- Settings Dropdown -->
                <div class="relative">
                    <x-jet-dropdown align="right" width="44">
                        <x-slot name="trigger">
                                <button class="flex text-white text-xs font-medium px-3 hover:bg-neutral-900 bg-red-700 py-3 rounded-full focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out">
                                    {{ __('Buscar por') }} {{$tipo1 ? :''}}
        ...
        <div class="w-full relative pl-2 flex-1">
            <form class="relative text-gray-700" autocomplete="off">
                <input wire:model.debounce.500ms="search" class="rounded-full focus:bg-white border-2 border-red-700 focus:ring-red-700 focus:outline-none focus:border-red-700 focus:ring-1 w-full h-10 px-5 text-sm"
