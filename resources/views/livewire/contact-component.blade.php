<div>
    ...
    <div class="px-2 md:px-10 py-4 space-y-3">
        <div class="">
            <label class="text-sm font-semibold pr-2" for="">{{ __('Name') }}</label>
            <input wire:model.defer="name" class="rounded-lg h-8 w-full block" placeholder="{{ __('Escriba su nombre') }}"
                type="text" name="name">
            @error('name')
        ...
        <div>
            ...
            <input wire:model.defer="email" class="rounded-lg h-8 w-full block" placeholder="Ejemplo: espochep@gmail.com"
        ...
        <div>
            ...
            <input wire:model.defer="subject" class="rounded-lg h-8 w-full block"
                placeholder="Ejemplo: Informacion Sobre Compras Puplicas" type="text" name="">
            @error('subject')
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-1 rounded relative mt-1" role="alert">
                    <strong class="font-bold">Ups!</strong>
                    <span class="block sm:inline">{{ $message }}</span>
