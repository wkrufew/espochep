<x-app-layout>
    @section('meta_tag')
    <title>ESPOCHEP|NEWS</title>
        {{-- SEO --}}
        <meta name="robots" content="index, follow">
        <meta name="title" content="ESPOCH EP|NEWS">
        <meta name="description" content="ESPOCHEP, es una empresa dedicada a las compras publicas" >
        <!-- Open Graph data -->
        <meta property="og:title" content="ESPOCH EP|NEWS">
    ...
    <div class="w-full md:max-w-3xl mx-auto px-3 md:px-4 mb-5">
        <div class="bg-white py-2 px-1 md:px-6 rounded-lg shadow-lg">
            @livewire('search-noticia')
        </div>
    </div>
    <div class="max-w-7xl mx-auto py-2 px-2 mb-4">
        @livewire('notice-filter')
    </div>
</x-app-layout>
