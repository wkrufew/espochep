...
@section('content_header')
    <h1>Ingresar Integrante</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-body">
            {!! Form::open(['route' => 'admin.integrantes.store', 'files' => true, 'autocomplete' => 'off']) !!}
            ...
            {!! Form::submit('Ingresar Integrante', ['class' => 'btn btn-primary mt-2']) !!}
            {!! Form::close() !!}
        </div>
    </div>
@stop
